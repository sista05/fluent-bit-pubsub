...
| [Uuid](#Note)            | add UUID to attributes. (keyname:uuid) | false |
...
| [Attributes](#Note)         | publish a log embedded custom attributes as metadata. (value is fixed)| NONE(optional) |
...
The Uuid, Attributes options are not supported.
